...
export const GET: RequestHandler = async () => {
    ...
    const res = await db.raw(
        ...
        ember.halal_ido, ember.halal_ok, CONCAT((Select nev from orszag where id = halalhely.orszag), ', ', halalhely.megye, ', ', halalhely.iranyitoszam, ' ', halalhely.helyseg) as halal_hely
        from ember
